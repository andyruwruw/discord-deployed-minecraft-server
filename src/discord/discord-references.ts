...
export class DiscordReferences {
   ...
   */
  static Channel = {} as Record<ChannelType, TextChannel | null>;

  /**
   * Static references to Discord roles.
   */
  static Role = {} as Record<RoleType, DiscordRole | null>;

  /**
   * Static references to guild players.
   */
  static PlayerByDiscord = {} as Record<string, GuildMember | null>;

  /**
   * Static references to guild players.
   */
  static PlayerByMinecraft = {} as Record<string, GuildMember | null>
